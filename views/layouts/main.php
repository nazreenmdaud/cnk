...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo Yii::app()->request->baseUrl; ?>/layouts/favicon.png" type="image/x-icon" />
        <script language="JavaScript"  src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
        <link  href="<?php echo Yii::$app->request->baseUrl ?>/front/lib/fancybox-master/dist/jquery.fancybox.min.css" rel="stylesheet">
        <script src="<?php echo Yii::$app->request->baseUrl ?>/front/lib/fancybox-master/dist/jquery.fancybox.min.js"></script>
                ...
                <div class="wow fadeIn">
                    <div class="hero-logo">
                        <a href="<?php echo Yii::$app->request->baseUrl . '/site/index' ?>" title="Back to Home">
                            <img class="logo-min" src="<?php echo Yii::$app->request->baseUrl ?>/front/img/cnklogo.png" alt="cnk logo">
                        </a>
                    </div>
                    <?= $content ?>
